  ...
  return (
    <div className="flex flex-row w-screen h-screen items-center justify-center bg-redishpink-100 font-display">
      <div className="bg-gray-100 h-[36 rem] w-[30rem] border-8 border-gray-300 rounded-2xl">
        <h2 className="font-display font-bold text-5xl text-center mt-6">
          Login
        </h2>
        <form
          onSubmit={handleSubmit}
          className="ml-12 mt-12 font-display text-xl"
        >
        ...
        {message && (
          <p className={`${messageStyle} font-bold text-lg text-center mt-8`}>
            {message}
          </p>
        )}
        <p className="text-center mt-12 font-bold font-display text-lg mb-2">
          New here?{" "}
