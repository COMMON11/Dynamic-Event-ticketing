      ...
      <div className="min-h-screen bg-redishpink-100 pt-4 px-2">
        ...
        <div className="flex justify-between items-center  mx-64 mt-44">
          <div className="relative">
            <Link to="/createEvent">
              <button className="h-[30rem] w-[30rem] font-display font-bold text-6xl bg-white relative z-10 transition-all duration-500 ease-in-out border-4 border-gray-300 hover:border-8 hover:border-gray-500 active:translate-x-12 active:translate-y-12">
                Create Event
              </button>
            </Link>
